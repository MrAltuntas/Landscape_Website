...
(function ($) {
    ...
    $.fn.EasySlides = function (options) {
        ...
        return this.each(function () {
            ...
            var count = $(this_slider).children('*:not(.zoom_button, .next_button, .prev_button, .nav_indicators)').length;
            var cur_slide = 0;
            ...
            if (count > 0) {
                ...
                while (count < settings['show']) {
                    ...
                    slides = $(this_slider).children('*:not(.zoom_button, .next_button, .prev_button, .nav_indicators)');
